...
static void deinterlace_frame_di_greedy2frame( unsigned char *output,
                                               ...
                                               int bottom_field, int width, int height )
{
    ...
    di_greedy2frame->pfnAlgorithm( &Info );
}
...
static deinterlace_method_t greedymethod =
{
    ...
    0,
    0,
    deinterlace_frame_di_greedy2frame
};
...
#endif
{
    di_greedy2frame = LoadDeintPlugin( "../data/DI_Greedy2Frame.dll" );
    if( di_greedy2frame ) {
