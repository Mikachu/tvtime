...
static DEINTERLACE_METHOD *di_greedy;

static void deinterlace_frame_di_greedy( uint8_t *output, int outstride,
...
#endif
{
    di_greedy = load_dscaler_deinterlacer( "DI_Greedy.dll" );
    if( di_greedy ) {
