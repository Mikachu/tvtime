...
static DEINTERLACE_METHOD *di_twoframe;

static void deinterlace_frame_di_twoframe( unsigned char *output,
                                           ...
                                           int bottom_field, int width, int height )
{
    ...
    di_twoframe->pfnAlgorithm( &Info );
}

static deinterlace_method_t greedymethod =
{
    DEINTERLACE_PLUGIN_API_VERSION,
    "TwoFrame (Dscaler DLL)",
    "2-Frame",
    4,
    MM_ACCEL_X86_MMXEXT,
    0,
...
#endif
{
    di_twoframe = LoadDeintPlugin( "../data/DI_TwoFrame.dll" );
    if( di_twoframe ) {
