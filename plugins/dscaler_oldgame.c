...
static DEINTERLACE_METHOD *di_oldgame;

static void deinterlace_frame_di_oldgame( unsigned char *output,
...
#endif
{
    di_oldgame = LoadDeintPlugin( "../data/DI_OldGame.dll" );
    if( di_oldgame ) {
