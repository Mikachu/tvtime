...
static DEINTERLACE_METHOD *di_videobob;

static void deinterlace_frame_di_videobob( unsigned char *output,
...
#endif
{
    di_videobob = LoadDeintPlugin( "../data/DI_VideoBob.dll" );
    if( di_videobob ) {
