...
static const KeyBindDef key_def[] =
{
    ...
    {'c',	TVTIME_TOGGLE_LUMA_CORRECTION},
    {'x',	TVTIME_LUMA_UP},
    {'z',	TVTIME_LUMA_DOWN},
    {'m',	TVTIME_MIXER_MUTE},
    {'+',	TVTIME_MIXER_UP},
    ...
    {I_F11,	TVTIME_TOGGLE_BARS},
    {I_F12,	TVTIME_TOGGLE_CREDITS},
    {'d',	TVTIME_DEBUG},
    {'f',	TVTIME_TOGGLE_FULLSCREEN},
    {'i',	TVTIME_TOGGLE_INPUT},
    {'a',	TVTIME_TOGGLE_ASPECT},
    {'s',	TVTIME_SCREENSHOT},
...
static const Cmd_Names cmd_table[] = {
    ...
    { "FULLSCREEN", TVTIME_TOGGLE_FULLSCREEN },
